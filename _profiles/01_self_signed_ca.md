...
| Subject   |       |       |   Unique X.500 subject DN matches the Issuer DN.<br>PrintableString encoding should be used wherever possible for Issuer and Subject Distinguished Names.   |
