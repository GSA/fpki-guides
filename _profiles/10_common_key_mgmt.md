...
| Subject   |       |       |   Unique X.500 Subject DN of the owner of the subject public key in the certificate.<br>PrintableString encoding should be used whenever possible for Issuer and Subject DNs.   |
...
| Certificate Policies   | Mandatory  |  | Applicable certificate policies.<br>Three policy OIDs are defined for key-management certificates issued to human subscribers under the _X.509 Certificate Policy for the U.S. Federal PKI Common Policy Framework_ (aka, Common Policy CP). End entity certificates should assert one of three policies:<br>id-fpki-common-policy {2.16.840.1.101.3.2.1.3.6}<br> id-fpki-common-hardware {2.16.840.1.101.3.2.1.3.7}<br>id-fpki-common-High {2.16.840.1.101.3.2.1.3.16}<br>Other policy OIDs may be asserted as well. |
