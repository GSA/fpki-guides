...
| Issuer   |       |       |  Unique X.500 Issuing CA DN.<BR>Issuer name should be encoded exactly as encoded in the issuer fields of the certificates that are covered by this CRL. PrintableString encoding should be used whenever possible for Issuer Distinguished Names. |
