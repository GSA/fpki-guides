...
| Certificate Policies   | Mandatory  |  | At least one of the applicable certificate policies must be mapped to FBCA mediumHW or PIV-I Hardware. |
| Authority Key Identifier   | Mandatory  |  | Octet string (same as subject key identifier in Issuing CA certificate). |
| Extended Key Usage   | Optional |  |  If included to support specific applications, the extension should be non-critical. The 3 values listed for keyPurposeID should be included for signing purposes:<br>Id-kp-emailProtection {1.3.6.1.5.5.7.3.4}<br> MSFT Document Signing {1.3.6.1.4.1.311.10.3.12}<br>Adobe-Certified Document Signing {1.2.840.113583.1.1.5}<br>Additional key purposes may be specified.  |
