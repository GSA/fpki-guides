...
| Certificate Policies   | Mandatory  |  | Applicable certificate policies&mdash;at least one policy mapped to FBCA mediumHW or PIV-I Hardware. |
...
| Subject Directory Attributes   | Optional  |  | This extension may be included to indicate the cardholder's country or countries of citizenship, as specified in RFC 5280.<a name="2">2</a><BR>countryOfCitizenship {1.3.6.1.5.5.7.9.4} (ISO 3166.<a name="3">3</a>) | 
...
<a name="2">2</a>. RFC 5280, _Internet X.509 Public Key Infrastructure Certificate and Certificate Revocation List (CRL) Profile_, David Cooper, Stefan Santesson, Stephen Farrell, Sharon Boeyen, Russell Housley, and Tim Polk (May 2008).
